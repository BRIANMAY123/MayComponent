...
export const BButtonWithSize = Template.bind({})
BButtonWithSize.args = {
  children: 'Button',
}
BButtonWithSize.decorators = [
  (Story) => (
    <>
      <Story size="lg"> large button </Story>
      <Story size="sm"> small button </Story>
    </>
  ),
]
BButtonWithSize.storyName = '不同尺寸的按钮'

export const CButtonWithType = Template.bind({})
CButtonWithType.args = {
  children: 'Button',
}
CButtonWithType.decorators = [
  (Story) => (
    <>
      <Story btnType="primary"> primary button </Story>
      <Story btnType="danger"> danger button </Story>
      <Story btnType="link" href="https://google.com"> link button </Story>
    </>
  ),
]
CButtonWithType.storyName = '不同类型的按钮'